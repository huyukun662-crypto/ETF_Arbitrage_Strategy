...
8. **IS/OOS discipline** (from global AGENTS.md): split is **IS = 2018-2023, OOS = 2024-2026**. OOS is **read-only**; reverse-tuning to fit a 2024 event is forbidden.
...
Every grid-search script must emit three CSVs (per global AGENTS.md 量化研发工程纪律):
